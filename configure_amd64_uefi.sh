...
EOF
# LANG=${LOCALE}.${ENCODING}
# LC_ADDRESS=${LOCALE}.${ENCODING}
# LC_IDENTIFICATION=${LOCALE}.${ENCODING}
# LC_MEASUREMENT=${LOCALE}.${ENCODING}
# LC_MONETARY=${LOCALE}.${ENCODING}
# LC_NAME=${LOCALE}.${ENCODING}
# LC_NUMERIC=${LOCALE}.${ENCODING}
# LC_PAPER=${LOCALE}.${ENCODING}
# LC_TELEPHONE=${LOCALE}.${ENCODING}
# LC_TIME=${LOCALE}.${ENCODING}
...
pacman --noconfirm --sync dhcpcd net-tools openssh
...
# Replace legacy iptables with fancier iptables
# pacman --noconfirm --sync iptables-nft
# XXX FIXME TODO  Apparently there is no good way to automate this step!!!
